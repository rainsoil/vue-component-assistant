                    ...
                    protected void addCompletions(@NotNull CompletionParameters parameters,
                        ...
                        if (component.props != null) {
                            for (Prop prop : component.props) {
                                ...
                                if (!prefix.isEmpty() && !prop.name.toLowerCase().startsWith(prefix.toLowerCase()))
                                    continue;
                                String defaultText = prop.defaultValue != null ? String.valueOf(prop.defaultValue) : "";
                                String lookupString = prop.name + "=\"" + defaultText + "\"";
                        ...
                        if (component.events != null) {
                            for (Event event : component.events) {
                                ...
                                if (!prefix.isEmpty() && !eventAttr.toLowerCase().startsWith(prefix.toLowerCase()))
                                    continue;
