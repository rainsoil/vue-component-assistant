...
import com.chu7.vuecomponentassistant.validation.ValidationResult;
...
public class DataValidator {
     ...
     */
    @NotNull
    public com.chu7.vuecomponentassistant.validation.ValidationResult validateJson(@NotNull String jsonContent, @NotNull String dataType) throws JsonParseException {
        VueKitLogger.debug(LOG, "开始验证JSON数据，类型: " + dataType);
        
        com.chu7.vuecomponentassistant.validation.ValidationResult result = new com.chu7.vuecomponentassistant.validation.ValidationResult();
     ...
     */
    @NotNull
    public com.chu7.vuecomponentassistant.validation.ValidationResult validateComponents(@NotNull List<ElementPlusComponent> components, @Nullable Project project) {
        ...
        try {
            ...
            for (int i = 0; i < components.size(); i++) {
                ...
                com.chu7.vuecomponentassistant.validation.ValidationResult componentResult = validateComponent(component, i);
     ...
     */
    @NotNull
    public com.chu7.vuecomponentassistant.validation.ValidationResult validateComponent(@NotNull ElementPlusComponent component, int index) {
        com.chu7.vuecomponentassistant.validation.ValidationResult result = new com.chu7.vuecomponentassistant.validation.ValidationResult();
        ...
        try {
            ...
            if (component.getProps() != null) {
                for (int i = 0; i < component.getProps().size(); i++) {
                    com.chu7.vuecomponentassistant.validation.ValidationResult propResult = validateProperty(component.getProps().get(i), componentPrefix + ".属性[" + i + "]");
            ...
            if (component.getEvents() != null) {
                for (int i = 0; i < component.getEvents().size(); i++) {
                    com.chu7.vuecomponentassistant.validation.ValidationResult eventResult = validateEvent(component.getEvents().get(i), componentPrefix + ".事件[" + i + "]");
            ...
            if (component.getSlots() != null) {
                for (int i = 0; i < component.getSlots().size(); i++) {
                    com.chu7.vuecomponentassistant.validation.ValidationResult slotResult = validateSlot(component.getSlots().get(i), componentPrefix + ".插槽[" + i + "]");
     ...
     */
    @NotNull
    private com.chu7.vuecomponentassistant.validation.ValidationResult validateProperty(@NotNull ElementPlusProp prop, @NotNull String prefix) {
        com.chu7.vuecomponentassistant.validation.ValidationResult result = new com.chu7.vuecomponentassistant.validation.ValidationResult();
     ...
     */
    @NotNull
    private com.chu7.vuecomponentassistant.validation.ValidationResult validateEvent(@NotNull ElementPlusEvent event, @NotNull String prefix) {
        com.chu7.vuecomponentassistant.validation.ValidationResult result = new com.chu7.vuecomponentassistant.validation.ValidationResult();
     ...
     */
    @NotNull
    private com.chu7.vuecomponentassistant.validation.ValidationResult validateSlot(@NotNull ElementPlusSlot slot, @NotNull String prefix) {
        com.chu7.vuecomponentassistant.validation.ValidationResult result = new com.chu7.vuecomponentassistant.validation.ValidationResult();
     ...
     * 安全验证
     */
    private void validateSecurity(@NotNull String content, @NotNull com.chu7.vuecomponentassistant.validation.ValidationResult result) {
